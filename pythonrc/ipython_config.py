...
# c.TerminalIPythonApp.ipython_dir = u'/home/massimo/.ipython'
...
#Provides configurables for loading extensions and executing files as
#part of configuring a Shell environment.  Provides init_extensions()
#and init_code() methods, to be called after init_shell(), which must
...
# A file to be run c.InteractiveShellApp.file_to_run = ''
...
# this is 0, which means IPython will auto-detect your screen size
# every time it needs to print certain potentially long strings (this
# doesn't change the behavior of the 'print' keyword, it's only
# triggered internally). If for some reason this isn't working well
# (it needs curses support), specify it yourself. Otherwise don't
# change the default.
